...
;window.Modernizr = function(a, b, c) {
    ...
    var d = "2.7.1", e = {}, f = b.documentElement, g = "modernizr", h = b.createElement(g), i = h.style, j = b.createElement("input"), k = ":)", l = {}.toString, m = " -webkit- -moz- -o- -ms- ".split(" "), n = "Webkit Moz O ms", o = n.split(" "), p = n.toLowerCase().split(" "), q = {
...
!function(a, b) {
    ...
    function c(b) {
        ...
        return q.hasClass("wallpaper-inititalized") || (q.addClass("wallpaper-inititalized"),
        t.on("resize.wallpaper", c, l)),
        e
    }
    function d(b) {
        var c = a(this);
    ...
    function f(b, c, d, e) {
        ...
        g.one("load.wallpaper", function() {
            ...
            (!d || e) && (c.$target.trigger("wallpaper.loaded"),
            c.onLoad.call(c.$target)),
    ...
    function g(b, c, d) {
        if (c.source.poster && (f(c.source.poster, c, !0, !0),
        d = !1),
        !z) {
    ...
    function h(c, d, e) {
        ...
        if (d.posterLoaded || (d.poster || (d.poster = "http://img.youtube.com/vi/" + d.videoId + "/0.jpg"),
        d.posterLoaded = !0,
        f(d.poster, d, !0, e),
        e = !1),
        !z)
            if (a("script[src*='youtube.com/iframe_api']").length || a("head").append('<script src="https://www.youtube.com/iframe_api"></script>'),
            x) {
                ...
                d.player = new b.YT.Player(h,{
                    events: {
                        ...
                        onStateChange: function(c) {
                            d.playing || c.data !== b.YT.PlayerState.PLAYING ? d.loop && d.playing && c.data === b.YT.PlayerState.ENDED && d.player.playVideo() : (d.playing = !0,
                            (d.hoverPlay || !d.autoPlay) && d.player.pauseVideo(),
                            d.$target.trigger("wallpaper.loaded"),
                            d.onLoad.call(d.$target),
                            l.on(r, function(b) {
                                o(b),
                                a(b.target).is(l) && (l.off(r),
                                i(d))
                            }),
                            l.css({
                                opacity: 1
    ...
    function m() {
        u.each(function() {
            for (var b = a(this), c = (b.find("img"),
            b.parents(".wallpaper").data("wallpaper")), d = c.responsiveSource, e = 0, g = 0, h = d.length; h > g; g++)
    ...
    var q, r, s, t = a(b), u = null, v = "backgroundSize"in document.documentElement.style, w = 0, x = !1, y = [], z = /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(b.navigator.userAgent || b.navigator.vendor || b.opera), A = {
        autoPlay: !0,
        embedRatio: 1.777777,
        hoverPlay: !1,
        loop: !0,
        ...
        defaults: function(b) {
            return A = a.extend(A, b || {}),
            a(this)
        },
        destroy: function() {
            var b = a(this).each(function() {
                var b = a(this).data("wallpaper");
                b && (b.$container.remove(),
                b.$target.removeClass("wallpaper").off(".boxer").data("wallpaper", null))
            });
            return a(".wallpaper").length < 1 && (q.removeClass("wallpaper-inititalized"),
            t.off(".wallpaper")),
            b
        },
        load: function(b) {
            return a(this).each(function() {
                ...
                c && ("object" == typeof b && b.poster && (c.poster = b.poster,
                b = b.source),
                e(b, c))
            })
        },
...
;(function(window) {
    ...
    scrollReveal.prototype = {
        ...
        parseLanguage: function(el) {
            var words = el.getAttribute('data-scrollreveal').split(/[, ]+/), enterFrom, parsed = {};
        ...
        genCSS: function(el) {
            ...
            var transition = "-webkit-transition: all " + dur + " ease " + delay + ";" + "-moz-transition: all " + dur + " ease " + delay + ";" + "-o-transition: all " + dur + " ease " + delay + ";" + "transition: all " + dur + " ease " + delay + ";";
            var initial = "-webkit-transform: translate" + axis + "(" + dist + ");" + "-moz-transform: translate" + axis + "(" + dist + ");" + "transform: translate" + axis + "(" + dist + ");" + "opacity: 0;";
            var target = "-webkit-transform: translate" + axis + "(0);" + "-moz-transform: translate" + axis + "(0);" + "transform: translate" + axis + "(0);" + "opacity: 1;";
            return {
...
jQuery(document).ready(function() {
    ...
    $("div[id=project-details-carousel]").owlCarousel({
        navigation: true,
        slideSpeed: 300,
        paginationSpeed: 400,
        singleItem: true,
        navigationText: ["<i class='fa fa-angle-left'></i> Préc.", "Suiv. <i class='fa fa-angle-right'></i>"],
    });
    $(".container").fitVids();
